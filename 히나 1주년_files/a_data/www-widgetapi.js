...
function na(a,b,c,d){try{var e=b.call(a.g.h,c);if(!(e instanceof Object))throw new TypeError("Iterator result "+e+" is not an object");if(!e.done)return a.g.j=!1,e;var k=e.value}catch(g){return a.g.h=null,B(a.g,g),C(a)}a.g.h=null;d.call(a.g,k);return C(a)}
...
function yb(){return qa(function(a){var b=a.return;var c=Ua()>=119;return b.call(a,c&&!!navigator.permissions&&!!navigator.permissions.query&&"requestStorageAccessFor"in document)})}
